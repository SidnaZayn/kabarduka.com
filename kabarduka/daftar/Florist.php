    ...
    <main id="main">
        <div class="daftar-kabarduka">
            ...
            <div class="container pendaftaran" id="pendaftaran">
                ...
                <form action="dbFlorist.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Nama Florist</label>
                        <input class="form-control" name="nama_florist" required oninvalid="this.setCustomValidity('Masukan Nama')" oninput="this.setCustomValidity('')" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="alamat_florist" required oninvalid="this.setCustomValidity('Masukan Alamat')" oninput="this.setCustomValidity('')" />
                    </div>
                    <div class="form-group">
                        <label>WA Florist</label>
                        <input class="form-control" name="wa_florist" required oninvalid="this.setCustomValidity('Masukan Nomer WA')" oninput="this.setCustomValidity('')" />
                    </div>
                    <div class="form-group">
                        <label>Bank Florist</label>
                        <input class="form-control" name="bank_florist" required oninvalid="this.setCustomValidity('Masukan Bank')" oninput="this.setCustomValidity('')" />
                    </div>
                    <div class="form-group">
                        <label>AC Bank Florist</label>
                        <input class="form-control" name="ac_bank_florist" required oninvalid="this.setCustomValidity('Masukan Nomer')" oninput="this.setCustomValidity('')" />
                    </div>
