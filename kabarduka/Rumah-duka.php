...
<body>
    ...
    <main id="main">
        ...
        <div class="container">
            <center>
                <h1 style="margin-bottom: 20px;">List Rumah Duka Di Indonesia</h1>
            </center>
            <br>
            <div class="tbl">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <p><a class="popup-with-move-anim" href="#a<?php echo $row['id_rumah_duka'] ?>"><button type="button" class="btn btntb">Lihat</button></a></p>
                                </td>
                            </tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="lightbox-body">
                                            ...
                                            <a href="daftar/kirim-bunga/kirim-bunga.php"><button class="button" style="float: right; margin:5px;">Kirim Bunga</button></a>
                                            <a target="_blank" href="http://maps.google.com/maps?q=<?php echo $row['latitude'] ?>,<?php echo $row['longitude'] ?>"><button class="button" style="float: right; margin:5px;">Lihat Di Maps</button></a>
                                        </div>
                                    </div> <!-- end of col -->
                                </div> <!-- end of row -->
