        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group" hidden>
                        <label>ID</label>
                        <input class="form-control" name="id_rumah_duka" value="<?php echo $tampil['id_rumah_duka'] ?>" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="latitude" value="<?php echo $tampil['latitude'] ?>" />
                    </div>
                    <div class="form-group">
                        <label>Longitude</label>
                        <input class="form-control" name="longitude" value="<?php echo $tampil['longitude'] ?>" />
                    </div>
                    <div>
...
$simpan = @$_POST['simpan'];
if ($simpan) {
    $sql = $koneksi->query("UPDATE tb_mrumah_duka set id_kota='$id_kota',nama_rumah_duka='$nama_rumah_duka',alamat_rumah_duka='$alamat_rumah_duka',telp_rumah_duka='$telp_rumah_duka',wa_rumah_duka='$wa_rumah_duka',latitude='$latitude',longitude='$longitude'
